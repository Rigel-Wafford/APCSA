...
/**
 * Prints the gross pay, the federal tax, the state tax, the total deduction,
 * and the net pay of an employee based on their hourly pay rate, their federal
 * tax withholding rate, and their state tax withholding rate.
 *
 * @author Rigel W.
 */
public class C4_3 {
